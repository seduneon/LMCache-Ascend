...
from simulator.core.request import RequestStatus
from simulator.runtime.tasks import BatchLoadTask, EvictTask, ForwardTask, StoreTask, Task

if TYPE_CHECKING:
    from simulator.runtime.engine import Engine
    from simulator.runtime.plan import BatchPlan
